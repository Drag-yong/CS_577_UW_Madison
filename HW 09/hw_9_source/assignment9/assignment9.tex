...
\begin{parts}
\part Let $s_O, s_A, s_B, s_{AB}$ denote the hospital's blood supply on hand, and let $d_A, d_B, d_O, d_{AB}$ denote their projected demand for the coming week. Give a polynomial time algorithm to evaluate whether the blood supply is enough to cover the projected need.
